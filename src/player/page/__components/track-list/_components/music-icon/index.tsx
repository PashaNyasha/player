...
export const MusicIcon = memo(() => (
  ...
  >
    ...
    <path
      style={{fill: "#FEA832"}}
      d="M242,167c0,41.4-33.6,75-75,75c-8.401,0-15-6.601-15-15c0-8.401,6.599-15,15-15
    ...
    <path
      style={{fill: "#FFD400"}}
      d="M106,262.7C95.2,250.099,78.999,242,61,242c-32.999,0-61,26.999-61,60c0,32.999,28.001,60,61,60
    ...
    <path
      style={{fill: "#00EED0"}}
      d="M506,124.999c-3.6-2.699-8.699-3.6-13.2-2.401L392,151.399l-109.2,31.199
	c-6.299,1.8-10.8,7.8-10.8,14.401v79.799l30-8.399l90-25.801l90-25.8l30-8.399V137C512,132.199,509.9,128,506,124.999z"
    />
    <path
      style={BLUE_FILL}
      d="M512,137v71.4l-30,8.399l-90,25.8V151.4l100.8-28.801c4.501-1.199,9.6-0.298,13.2,2.401
